...
import Frame65Image3 from '../assets/images/frame65-image3.png'; 
import Frame65Image4 from '../assets/images/frame65-image4.png'; 
  ...
  return (
    <div className="page page-21-p21"> {/* Исправлено */}
      ...
      <div className="frame-65-p21">
        {/* Frame 63 */}
        {renderExerciseBlock("frame63", "2A", "2B", Frame65Image3)}
        
        {/* Frame 64 */}
        {renderExerciseBlock("frame64", "2C", "2D", Frame65Image4)}
      </div>
