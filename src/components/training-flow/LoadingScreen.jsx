...
function LoadingScreen({ tvConfig, error, onRetry }) {
  ...
  console.log('zone:', tvConfig?.zone);
    ...
    <div style={styles.loadingContainer}>
      <div style={styles.loadingContent}>
        ...
        <div style={styles.loadingConfig}>
          ...
          <div style={styles.configRow}>Телевизор: {tvConfig?.televisor_id || '...'}</div>
          <div style={styles.configRow}>Зал: {tvConfig?.room_name || '...'}</div>
          <div style={styles.configRow}>ID зала: {tvConfig?.room_id || '...'}</div>
        </div>
